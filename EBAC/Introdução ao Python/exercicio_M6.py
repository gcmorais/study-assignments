# -*- coding: utf-8 -*-
"""modulo_6_exercicios (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WIX5VoMHqC03jPgHMwxy-RUV_A7UFg0U
...
class ArquivoTexto(object):
  ...
  def __init__(self, arquivo: str):
    ...
    self.conteudo = self.extrair_linha(numero_linha)
...
class ArquivoCSV(ArquivoTexto):
    ...
    def extrair_colunas(self):
      return self.extrair_linha(numero_linha = 1).strip().split(sep=',')

    def extrair_coluna_da_linha(self, numero_linha: int, numero_coluna: int):
        linha = self.extrair_linha(numero_linha).strip().split(sep=',')
