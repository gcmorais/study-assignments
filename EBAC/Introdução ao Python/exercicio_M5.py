# -*- coding: utf-8 -*-
"""module_5_exercise_revisado.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rh8eVe692aUfXV4QZcurFvAfkAGaS_FC
...
valor_emprestimos_lista = list(map(lambda item: float(item['valor_emprestimos']), emprestimos))
...
valor_emprestimos_lista_filtrada = list(filter(lambda item: item > 0, valor_emprestimos_lista))
...
desvio_padrao_valor_emprestimos = math.sqrt(reduce(lambda x, y: x + y, map(lambda x: (x - media_valor_emprestimos) ** 2, valor_emprestimos_lista_filtrada)) / (len(valor_emprestimos_lista_filtrada) - 1))

# Outra forma de fazer sem usar o reduce seria utilizando a função stdev(), importada de statistics;
